...
Some meta on this blog: it's built using [[https://kelvinh/org-page][org-page]], a static site generator
...
The variable =my-op-project= references the currently selected project, and
=my-op-project-policy= a 0-arity function which can choose which project to
select. The default policy is to ask the user if =my-op-project= is falsy.
